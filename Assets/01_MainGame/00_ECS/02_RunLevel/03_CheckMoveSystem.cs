    ...
    sealed class S_03_CheckMoveSystem : IEcsRunSystem
    {
        ...
        void IEcsRunSystem.Run()
        {
            if (!_checkFilter.IsEmpty())
            {
                ...
                //Проверяем можем ли мы двинуть квадрат
                ...
                //дальние квадраты должны ходить первыми (на их место встают другие)
                SquaresToMove.Reverse();

                SaveUndo();

                //рассчитываем начальную и конечные точки перемещения
        ...
        //Проверяем возможность движения, есть ли пустая клетка куда можно сдвинутся
        ...
        /// <summary>Запоминаем все квадраты для возврата в это состояние </summary>
